...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of tGFX_Task */
  osThreadDef(tGFX_Task, StartTouchGFX, osPriorityNormal, 0, 16384);
  tGFX_TaskHandle = osThreadCreate(osThread(tGFX_Task), NULL);

  /* definition and creation of BSPTask */
  osThreadDef(BSPTask, StartBSPTask, osPriorityNormal, 0, 8192);
  BSPTaskHandle = osThreadCreate(osThread(BSPTask), NULL);

  /* definition and creation of LogicTask */
  osThreadDef(LogicTask, StartLogicTask, osPriorityNormal, 0, 4096);
...
/**
* @brief Function implementing the tGFX_Task thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_StartBSPTask */
/**
