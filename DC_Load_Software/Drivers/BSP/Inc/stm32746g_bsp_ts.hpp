...
#ifndef __STM32746G_BSP_TS_H
#define __STM32746G_BSP_TS_H
...
#include "../../Components/tsc2013/tsc2013.h"	 
	
typedef enum
{
	STMPE811,
	TSC2013
} TOUCH_ControllerTypeDef;	 
extern TOUCH_ControllerTypeDef Touch_Controller;	 

#define TS_I2C_ADDRESS                   (0x41<<1)
...
typedef enum 
{
  ...
  TS_DEVICE_NOT_FOUND  = 0x03,  /*!< Touchscreen device not found */
	TS_DEVICE_NOT_VALID  = 0x04  /*!< Touchscreen device not valid */
}TS_StatusTypeDef;
